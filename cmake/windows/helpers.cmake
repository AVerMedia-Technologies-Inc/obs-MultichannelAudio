...
# add_target_properties_plugin: Add additional dlls for target in obs-studio
function(add_target_additional_deps target)
  cmake_parse_arguments(PARSE_ARGV 0 _AVT "" "" "MORE_FILES")

  # Access the multi-value argument
  foreach(item IN ITEMS ${_AVT_MORE_FILES})
	...
	if(OBS_BUILD_DIR)
      add_custom_command(
        ...
        POST_BUILD
        COMMAND "${CMAKE_COMMAND}" -E make_directory "${OBS_BUILD_DIR}/obs-plugins/64bit"
        COMMAND "${CMAKE_COMMAND}" -E copy_if_different "${item}" "${OBS_BUILD_DIR}/obs-plugin/64bit"
        COMMENT "Copy ${item} to obs-studio directory ${OBS_BUILD_DIR}"
        VERBATIM)
    endif()
  endforeach()
